...
configs.forEach(config => {
  describe(`WH65 device should be configured ${config}`, () => {
    ...
    it('Services are created with name overrides', (done) => {
      ...
      platform.config.nameOverrides[11] = {'key': 'WH65:rainLast24hTotal', 'value': 'Test Rain Last 24h Total Name'};
      platform.config.nameOverrides[12] = {'key': 'WH65:rainDailyTotal', 'value': 'Test Rain Daily Total Name'};
      platform.config.nameOverrides[13] = {'key': 'WH65:rainWeeklyTotal', 'value': 'Test Rain Weekly Total Name'};
      platform.config.nameOverrides[14] = {'key': 'WH65:rainMonthlyTotal', 'value': 'Test Rain Monthly Total Name'};
      platform.config.nameOverrides[15] = {'key': 'WH65:rainYearlyTotal', 'value': 'Test Rain Yearly Total Name'};
      platform.config.nameOverrides[16] = {'key': 'WH65:rainTotal', 'value': 'Test Rain Total Name'};
