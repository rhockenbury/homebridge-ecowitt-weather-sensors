...
configs.forEach(config => {
  describe(`WN67 device should be configured ${config}`, () => {
    ...
    it('Services are created with name overrides', (done) => {
      ...
      platform.config.nameOverrides[9] = {'key': 'WN67:rainLast24hTotal', 'value': 'Test Rain Last 24h Total Name'};
      platform.config.nameOverrides[10] = {'key': 'WN67:rainDailyTotal', 'value': 'Test Rain Daily Total Name'};
      platform.config.nameOverrides[11] = {'key': 'WN67:rainWeeklyTotal', 'value': 'Test Rain Weekly Total Name'};
      platform.config.nameOverrides[12] = {'key': 'WN67:rainMonthlyTotal', 'value': 'Test Rain Monthly Total Name'};
      platform.config.nameOverrides[13] = {'key': 'WN67:rainYearlyTotal', 'value': 'Test Rain Yearly Total Name'};
      platform.config.nameOverrides[14] = {'key': 'WN67:rainTotal', 'value': 'Test Rain Total Name'};
