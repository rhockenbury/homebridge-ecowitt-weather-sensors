...
> :arrow_up: :arrow_up: :arrow_up: **v2 is available with a better plugin UI, more supported gateway and console devices, and many other improvements. See the [config migration guide](https://github.com/rhockenbury/homebridge-ecowitt-weather-sensors/wiki/V2-Migration-Guide) for how to get started with v2.**
